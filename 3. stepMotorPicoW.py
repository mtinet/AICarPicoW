...
# 테스트 루프: 중앙 -> 왼쪽 13도 -> 중앙 -> 오른쪽 13도 -> 중앙 반복
while True:
    print("--- Moving: CENTER to LEFT (13 degrees) ---")
    step_rotate(direction='left', degrees=13)
    utime.sleep(1)

    print("--- Moving: LEFT to CENTER (13 degrees) ---")
    step_rotate(direction='right', degrees=13)
    utime.sleep(1)

    print("--- Moving: CENTER to RIGHT (13 degrees) ---")
    step_rotate(direction='right', degrees=13)
    utime.sleep(1)

    print("--- Moving: RIGHT to CENTER (13 degrees) ---")
    step_rotate(direction='left', degrees=13)
    utime.sleep(2) # 전체 사이클 반복 전 2초 대기
